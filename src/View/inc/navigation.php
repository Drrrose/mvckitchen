...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-warning navbar-light elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="admin" class="brand-link bg-warning text-sm">
        ...
        <span class="brand-text font-weight-light text-light"></span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-1">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./index.php?sales/showSale" class="nav-link nav-sales_manage_sale">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./index.php?order/allOrders" class="nav-link nav-orders">
