            ...
            <div class="card-body">
                <form method="post" action="<?php echo base_url; ?>register/register">
                    <div class="form-group">
                        ...
                        <input type="text" name="firstname" class="form-control form-control-lg <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['firstname']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="middlename">middlename<sub>*</sub></label>
                        <input type="text" name="middlename" class="form-control form-control-lg" value="<?php echo $data['middlename']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="lastname" class="form-control form-control-lg " value="<?php echo $data['lastname']; ?>">
                    </div>
                    <div class="form-group">
